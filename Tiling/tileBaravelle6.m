...
%cmap=[0.7 0.6 0.8;0.8 0.7 0.6;0.8 0.7 0.6;0.7 0.6 0.8];
%cmap = makeColorMap([1 1 1],[1 0.75 0.22],4);
%cmap=pink(4);
theta=0;
    ...
    for col=1:4
        ...
        for n=[2 4]
            ...
            for k=1:15
                ...
                patch(x-offx1+xoff,y-offy1+yoff,'r','facecolor',cmap(n,:)/sqrt(k),...
        ...
        for n=[1 3]
            ...
            for k=1:15
                ...
                patch(x-offx+xoff2,y-offy+yoff2,'r','facecolor',cmap(n,:)/sqrt(k),...
                    'edgecolor',cmap(n,:)/sqrt(k),'linewidth',0.01);
                patch(x-offx+xoff2,-y+offy+yoff2,'r','facecolor',cmap(n,:)/sqrt(k),...
                    'edgecolor',cmap(n,:)/sqrt(k),'linewidth',0.01);
                theta=theta+phi;
